-- 泄爆分析看图诊断数据计划参考 SQL（analysis_plan_img_diag_leakage_burst · q1～q5）
-- 对照：configs/prompts.yaml → analysis_plan_img_diag_leakage_burst / analysis_synthesis_img_diag_leakage_burst
