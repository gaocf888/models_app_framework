...
>
> **并行能力**：检修结构化 **V0**（LangGraph + **`paddleocr-layout-deploy`** 版面侧车）见 **`framework-guide/报告解析企业级实现方案V0.md`** 与 **`enterprise-level_transformation_docs/企业级检修报告结构化提取V0版本实现和使用说明.md`**；与现网 **`/inspection-extract`** 长期并存。
