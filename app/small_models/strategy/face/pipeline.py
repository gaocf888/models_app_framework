...
from app.small_models.common.roi import RoiRuntime
from app.small_models.strategy.base._insightface_utils import FaceInsight
from app.small_models.strategy.face.gallery_index import FaceGalleryIndex
...
def analyze_faces(
    faces: List[FaceInsight],
    gallery_index: FaceGalleryIndex | None,
    *,
    threshold: float,
    face_alert_mode: str,
) -> tuple[
